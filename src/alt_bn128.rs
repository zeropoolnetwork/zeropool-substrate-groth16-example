...
///
/// ```
pub fn alt_bn128_g1_multiexp(data: &[u8]) -> Result<Vec<u8>, AltBn128Error> {
...
///
/// ```
pub fn alt_bn128_g1_sum(data: &[u8]) -> Result<Vec<u8>, AltBn128Error> {
...
///
/// ```
pub fn alt_bn128_pairing_check(data: &[u8]) -> Result<bool, AltBn128Error> {
